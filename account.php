...
<div class="container">
  ...
  <input type="hidden" name="type" value="modify-email-username">
    ...
    <form action="./controllers/Users.php?id=<?=$id?>" method="post">
    <input type="hidden" name="type" value="register-account">
        ...
        <input type="tel" name="phoneNumber" id="phoneNumber"  pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" placeholder="xx-xx-xx-xx-xx">
